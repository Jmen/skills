...
- There may be a combination of end to end, integration and unit tests, but they should provide an overlapping coverage of everything important to know that the code is safe to release
